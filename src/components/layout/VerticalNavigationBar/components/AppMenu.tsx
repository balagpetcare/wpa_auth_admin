  ...
  return ()
    <Link
      ...
      {isNotificationsItem && unreadCount > 0 && ()
        <>
          <span className="badge bg-danger text-white ms-auto notification-menu-badge d-none d-lg-inline-flex">{badgeText}</span>
          <span className="notification-menu-dot d-lg-none" aria-hidden="true" />
        </>
      )}
    </Link>
