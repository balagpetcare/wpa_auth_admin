...
export default function EmailGatewayDetailPage() {
    ...
    <>
      ...
      <TestSendModal
        ...
        onSend={async ({ recipient, subject, message }) => {
          const res = await communicationApi.testEmailProvider(provider.id, recipient, subject || 'WPA Central Auth provider test', message)
          adminToast.success('Test email sent', res.message || 'The provider test was completed successfully.')
          await load()
        }}
      />
    </>
