...
const CustomFlatpickr = dynamic(() => import('@/components/CustomFlatpickr'), { ssr: false }
const ChoicesFormInput = dynamic(() => import('@/components/form/ChoicesFormInput'), { ssr: false }
